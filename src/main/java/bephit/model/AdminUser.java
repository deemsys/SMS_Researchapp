...
public class AdminUser
{
	...
	public AdminUser(String admin_id,String admin_firstname,String admin_username,String admin_password,String admin_email,String admin_mobile,String date,String status)
	{
		this.admin_id=admin_id;
