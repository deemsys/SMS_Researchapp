...
public class TwilioSMS {
    ...
    public static final String FROM_PHONE_NUMBER = "6142598990";
    ...
    private void sendMessage(final String toNumber, final String MessageBody, final String mediaUrl) throws TwilioRestException {
        ...
        smsParams.put("From", FROM_PHONE_NUMBER); // Replace with a valid phone number in your account. //Store in DB
