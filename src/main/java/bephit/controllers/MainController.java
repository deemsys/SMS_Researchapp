...
public class MainController {
	...
	private static final Logger logger = LoggerFactory
			.getLogger(MainController.class); // Logger
	...
	public ModelAndView printWelcome(HttpServletRequest request,
		...
		participantsDetailsForm1.setParticipantsDetails(mainDAO
				.getParticipants());
		ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
		participantsDetailsForm.setParticipantsDetails(mainDAO
				.getlimitedParticipants(1));
		model.addAttribute("participantsDetailsForm", participantsDetailsForm);
		model.addAttribute("currentpage", 1);
		model.addAttribute("noofrows", participantsDetailsForm1
				.getParticipantsDetails().size());
		participantsDetailsForm.setParticipantsDetails(mainDAO
				.getlimitedParticipants(1));
		model.addAttribute("noofpages",
				(int) Math.ceil(mainDAO.getnoofParticipants() * 1.0 / 5));
		...
		adminUserForm.setAdminuser(adminuserdao
				.getAdminUserby_username(principal.getName()));
	...
	public String viewallpart(HttpServletRequest request, ModelMap model,
			Principal principal) {
	...
	public String createSpitterProfile(HttpServletRequest request, Model model,
			Principal principal) {
	...
	public String addUserProfileFromForm(HttpServletRequest request,
	...
	public String viewParticipants(HttpServletRequest request, ModelMap model,
			Principal principal) {
		model.addAttribute("success", "false");
		ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
		participantsDetailsForm.setParticipantsDetails(mainDAO
	...
	public String removeParticipants(@RequestParam("id") String participant_id,
			ModelMap model, Principal principal) {
		...
		if (status == 1) {
			...
			participantsDetailsForm.setParticipantsDetails(mainDAO
					.getParticipants());
			model.addAttribute("participantsDetailsForm",
	...
	public String showAddParticipantGroups(HttpServletRequest request,
			ParticipantGroups pgroups, ModelMap model) {
	...
	public String NewParticipantGroups(HttpServletRequest request,
			@ModelAttribute("pgroups") @Valid ParticipantGroups pgroups,
			...
			if (result.hasErrors()) {
				if (partDAO.checkGroupname(pgroups) == 1) {
					if (result.hasFieldErrors("group_decs")) {
						participantGroupForm.setParticipantGroups(partDAO
								.getGroups());
						model.addAttribute("participantGroupForm",
	...
	public String AddParticipantGroups(HttpServletRequest request,
			ParticipantGroups pgroups, ModelMap model) {
		model.addAttribute("success", "false");
		ParticipantsGroupForm participantGroupForm = new ParticipantsGroupForm();
		participantGroupForm.setParticipantGroups(partDAO.getGroups());
	...
	public String viewParticipantGroups(HttpServletRequest request,
			ModelMap model) {
		model.addAttribute("success", "false");
		ParticipantsGroupForm participantGroupForm = new ParticipantsGroupForm();
		participantGroupForm.setParticipantGroups(partDAO.getGroups());
	...
	/*
	 * @RequestMapping(value="/viewadminuser", method=RequestMethod.GET) public
	 * String viewAdminUser(ModelMap model) {
	 * 
...
public String saveSettings(HttpServletRequest request,@ModelAttribute("textMsgSettings") TextMsgSettings textMsgSettings,ModelMap map, Principal principal){
	...
	public String addNewPwd(HttpServletRequest request,@ModelAttribute("updatePwds") @Valid UpdatePwd updatePwds,BindingResult result,ModelMap model,Principal principal){
		...
		if(result.hasErrors()){
			model.addAttribute("settings", "updatePwds");
			return "changepwd";
		}
...
//		updatePwdForm.setUpdatePwd(mailTemplateDAO.getOldPwd(request.getSession()));
		model.addAttribute("change", updatePwdForm);
		
		return "changepwd";
	}
	@RequestMapping(value = "/findParticipant", method = RequestMethod.GET)
	public String findparticipant(HttpServletRequest request,
			@RequestParam("mobile") String mobile,
			@RequestParam("groupname") String groupname,
			@RequestParam("city") String city, ModelMap model) {
		if (mobile == "" && groupname == "" && city == "") {
			...
			ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
			participantsDetailsForm.setParticipantsDetails(mainDAO
					.getParticipants(mobile, groupname, city));
			model.addAttribute("participantsDetailsForm",
					participantsDetailsForm);
			model.addAttribute("menu", "participants");
			ParticipantsGroupForm participantGroupForm = new ParticipantsGroupForm();
	...
	public String editParticipant(HttpServletRequest request,
			@RequestParam("id") String participants_id, ModelMap model,
			ParticipantsDetails participant) {

		ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
		participantsDetailsForm.setParticipantsDetails(mainDAO
				.getParticipants(participants_id));
		model.addAttribute("participantsDetailsForm", participantsDetailsForm);
		ParticipantsGroupForm participantGroupForm = new ParticipantsGroupForm();
		participantGroupForm.setParticipantGroups(partDAO.getGroups());
		model.addAttribute("participantGroupForm", participantGroupForm);
	...
	public String updateParticipant(
			...
			@ModelAttribute("participant") @Valid ParticipantsDetails participant,
			BindingResult result, ModelMap model, Principal principal) {

		if (result.hasErrors()) {
			ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
			participantsDetailsForm.setParticipantsDetails(mainDAO
					.getParticipants(participant.getParticipants_id()));
			model.addAttribute("participantsDetailsForm",
					participantsDetailsForm);
			ParticipantsGroupForm participantGroupForm = new ParticipantsGroupForm();
			participantGroupForm.setParticipantGroups(partDAO.getGroups());
		...
		int status = mainDAO.updateParticipants(participant,
				participant.getParticipants_id(), principal.getName());
		System.out.println(status);
	...
	public String deleteParticipantgroup(HttpServletRequest request,
			@RequestParam("id") String group_id, ModelMap model,
			Principal principal) {
	...
	public String participantdetails(HttpServletRequest request,
			@RequestParam("id") String participants_id, ModelMap model,
			ParticipantsDetails participant) {
		ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
		participantsDetailsForm.setParticipantsDetails(mainDAO
		...
		model.addAttribute("currentuser",
				request.getSession().getAttribute("currentuser"));
		/*
		 * ParticipantsGroupForm participantGroupForm = new
	...
	public String pageParticipants(HttpServletRequest request,
			@RequestParam("page") int page, ModelMap model) {

		ParticipantsDetailsForm participantsDetailsForm = new ParticipantsDetailsForm();
		participantsDetailsForm.setParticipantsDetails(mainDAO
				.getlimitedParticipants(page));
		model.addAttribute("noofpages",
				(int) Math.ceil(mainDAO.getnoofParticipants() * 1.0 / 5));
		model.addAttribute("participantsDetailsForm", participantsDetailsForm);
		model.addAttribute("noofrows", mainDAO.getParticipants().size());
	...
	public String deleteSelectedParticipants(HttpServletRequest request,
			ModelMap model, Principal principal) {
		String[] SelectedIDs = new String[100];
		SelectedIDs = request.getParameterValues("chkUser");
		for (String id : SelectedIDs) {
